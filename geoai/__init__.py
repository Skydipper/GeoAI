...
from geoai.config import SETTINGS
from geoai.routes.api import error
from geoai.routes.api.v1 import trend_analysis_endpoints_v1
from geoai.utils.files import load_config_json
...
# Routing
app.register_blueprint(trend_analysis_endpoints_v1, url_prefix="/api/v1/geoai/trends")
